...
3. Run the application using streamlit run frontend.py.

##About the Project
This project was created as part of a presentation at the Faculty of Electrical Engineering and Computing (FER) in Zagreb. The goal was to demonstrate the integration of open-source technologies like Hugging Face models and Pinecone vector databases to build a simple chatbot.
